...
urlpatterns = [
    ...
    path('<slug:slug>/add-episode', views.episode_add, name='episode_add'),
    path(
        '<slug:slug>/edit-episode/<int:episode_id>',
        views.episode_edit, name='episode_edit'),
    path(
        '<slug:slug>/delete-episode/<int:episode_id>',
        views.episode_delete, name='episode_delete'),
    path(
        'dashboard/add-podcast',
        views.podcast_add, name='podcast_add'),
    path(
        'dashboard/edit-podcast/<int:podcast_id>',
        views.podcast_edit, name='podcast_edit'),
    path(
        '<slug:slug>/delete-podcast/<int:podcast_id>',
